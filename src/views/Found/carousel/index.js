    ...
    return (
      <div>
        <div
          ...
          style={{
            backgroundImage: `url(${
              this.state.background[this.state.imgIndex]
            })`
          }}
          onMouseEnter={this.clearImgInterval}
          onMouseLeave={this._initImgInterval}
        >
          {/* 图片预加载 */}
          ...
          <div className="discover-wrapper">
            <div className="img-wrapper">
              ...
              <div className="a-dot">
                {this.state.imgURL.map((row, index) => {
                  return (
                    <span
                      onClick={this.tick.bind(this, index)}
                      className={`target-a ${
            ...
            <span
              onClick={this.tickIndex.bind(this, -1)}
